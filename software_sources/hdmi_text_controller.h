...
static volatile DATA* data = (DATA*) XPAR_HDMI_TEXT_CONTROLLER_0_AXI_BASEADDR;
// addr[0] = v1.y, v1.x
// addr[1] = v2.x, v1.z
// addr[2] = v2.z, v1.y
// addr[3] = v3.y, v3.x
// addr[4] = color, v3.z
// addr[5] = r_area
//static volatile DATA *data = (DATA *) 0x44A00000;
...
float sin_lookup(float radians) {
    // Normalize to [0, 2π)
    while (radians < 0.0f) radians += 6.283185f;
    while (radians >= 6.283185f) radians -= 6.283185f;
